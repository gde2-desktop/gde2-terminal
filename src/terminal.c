...
#define TERMINAL_FACTORY_SERVICE_NAME_PREFIX  "org.gde2.Terminal.Display"
#define TERMINAL_FACTORY_SERVICE_PATH         "/org/gde2/Terminal/Factory"
#define TERMINAL_FACTORY_INTERFACE_NAME       "org.gde2.Terminal.Factory"
                 ...
                 gpointer user_data)
{
	static const char dbus_introspection_xml[] =
	    "<node name='/org/gde2/Terminal'>"
	    "<interface name='org.gde2.Terminal.Factory'>"
