...
unsupported_option_callback (const gchar *option_name,
                             ...
                             GError     **error)
{
	g_printerr (_("Option \"%s\" is no longer supported in this version of gde2-terminal;"
...
get_goption_context (TerminalOptions *options)
{
	...
	g_option_context_set_description (context, N_("GDE2 Terminal Emulator"));

	group = g_option_group_new ("gde2-terminal",
	                            N_("GDE2 Terminal Emulator"),
	                            N_("Show GDE2 Terminal options"),
	                            options,
	                            NULL);
