 ...
 *
 * Gde2-terminal is free software; you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation; either version 3 of the License, or
 * (at your option) any later version.
 *
 * Gde2-terminal is distributed in the hope that it will be useful,
...
terminal_window_init (TerminalWindow *window)
{
    ...
    gtk_style_context_add_class (context, "gde2-terminal");
#endif
    ...
    gtk_notebook_set_group_name (GTK_NOTEBOOK (priv->notebook), I_("gde2-terminal-window"));
   ...
   update_edit_menu (window);
    ...
    terminal_util_set_unique_role (GTK_WINDOW (window), "gde2-terminal-window");
}
...
terminal_window_class_init (TerminalWindowClass *klass)
{
    ...
    gtk_rc_parse_string ("style \"gde2-terminal-tab-close-button-style\"\n"
                         "{\n"
                         ...
                         "ythickness = 0\n"
                         "}\n"
                         "widget \"*.gde2-terminal-tab-close-button\" style \"gde2-terminal-tab-close-button-style\"");
                             ...
                             TerminalWindow *window)
{
    ...
    gtk_window_set_role (GTK_WINDOW (dialog), "gde2-terminal-change-title");
                     ...
                     TerminalWindow *window)
{
    static const char copyright[] =
        ...
        "Copyright © 2012-2014 GDE2 developers";
    char *licence_text;
    GKeyFile *key_file;
    GError *error = NULL;
    ...
    gde2_show_about_dialog (GTK_WINDOW (window),
                           "program-name", _("GDE2 Terminal"),
                           "copyright", copyright,
                           "comments", _("A terminal emulator for the GDE2 desktop"),
                           "version", VERSION,
                           "authors", array_strv,
                           "artists", artists,
                           ...
                           "logo-icon-name", GDE2_TERMINAL_ICON_NAME,
