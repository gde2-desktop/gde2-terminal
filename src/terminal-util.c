                         ...
                         GtkWindow  *parent)
{
	...
	if (topic)
	{
		url = g_strdup_printf ("help:gde2-terminal/%s", topic);
	}
	else
	{
		url = g_strdup ("help:gde2-terminal");
	}
...
terminal_util_get_licence_text (void)
{
	const gchar *license[] =
	{
		N_("GDE2 Terminal is free software; you can redistribute it and/or modify "
		"it under the terms of the GNU General Public License as published by "
		"the Free Software Foundation; either version 3 of the License, or "
		"(at your option) any later version."),
		N_("GDE2 Terminal is distributed in the hope that it will be useful, "
		"but WITHOUT ANY WARRANTY; without even the implied warranty of "
		"MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the "
		"GNU General Public License for more details."),
		N_("You should have received a copy of the GNU General Public License "
		"along with GDE2 Terminal; if not, write to the Free Software Foundation, "
                                      ...
                                      guint32    desktop)
{
	 ...
	 * it starts)
	 *
	 * http://bugzilla.gde2.org/show_bug.cgi?id=586311 asks for GTK+
 ...
 *
 * http://bugzilla.gde2.org/show_bug.cgi?id=586664
 *
