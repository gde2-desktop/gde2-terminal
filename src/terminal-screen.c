...
terminal_screen_init (TerminalScreen *screen)
{
	const GtkTargetEntry target_table[] =
	{
		...
		{ "x-special/gde2-reset-background", 0, TARGET_RESET_BG },
...
/* TODO: Once Gtk2 support is dropped, gde2-terminal should be converted to use GdkRGBA everywhere instead of GdkColor. */
#if VTE_CHECK_VERSION (0, 38, 0)
static GdkRGBA *
                       ...
                       char **shell)
{
	...
	g_hash_table_remove (env_table, "GDE2_DESKTOP_ICON");
